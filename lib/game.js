(function() {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText('Objects: ' + this.allObjects().length, this.DIM_X - 800, 200);
  };
  ...
  Game.prototype.allObjects = function () {
    return this.bullets.concat(this.asteroids).concat(this.planets).concat([this.ship]).concat(this.items);
  };
